...
<body>
<h1><spring:message code="passwords.create.page.title"/></h1>
<a href="/"><spring:message code="password.list.link.label"/></a>

<div>
    <form:form action="/password/create" commandName="password" method="POST">
        <div>
        ...
        <div>
            <input type="submit" value="<spring:message code="passwords.create.page.submit.label"/>"/>
        </div>
    </form:form>
</div>
</body>
